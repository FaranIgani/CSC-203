...
/*
    public static void executeAnimationAction(Action action, EventScheduler scheduler) {
        ...
        if (action.repeatCount != 1) {
            scheduleEvent(scheduler, action.entity, createAnimationAction(action.entity,
                    Math.max(action.repeatCount - 1, 0)), action.entity.getAnimationPeriod());
        }
    }
*/
...
//            Entity entity = createSapling(id, pt, Functions.getImageList(imageStore, Entity.SAPLING_KEY), health);
...
//                case Functions.HOUSE_KEY -> WorldModel.parseHouse(world, properties, pt, id, imageStore);
...
//            return Optional.of(VirtualWorld.getCurrentImage(getBackgroundCell(world, pos)));
//        } else {
//            return Optional.empty();
//        }
//    }
...
//                view.screen.image(VirtualWorld.getCurrentImage(entity), viewPoint.x * view.tileWidth, viewPoint.y * view.tileHeight);
//            }
//        }
//    }
//
